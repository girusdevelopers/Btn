...
import css from "./appdocument.module.scss";
...
import DocmtIcon from "@/ui/icons/Docmt.icon";
import DoceditIcon from "@/ui/icons/Docedit.icon";
                ...
                <div className={css["table"]}>
                  <table className={css["table"]}>
                    <tr className={css["table"]}>
                      <td className={css["table2"]}>Brazil's Documents</td>
                    </tr>
                    <tr className={css["table"]}>
                    ...
                    <tr className={css["table"]}>
                      ...
                      <td className={css["th6"]}>
                        <div className={css["button"]}>
                          <div>
                            <button className={css["tab"]}>Approve</button>
                          </div>
                          <div>
                            <button className={css["tab2"]}>Disapprove</button>
                          </div>
                        </div>
                      </td>
                    </tr>
