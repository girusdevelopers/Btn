...
function Video() {
  ...
  const downloadAudio = () => {
    if (audioRef.current) {
      ...
      const audioSource = audioRef.current.src;

      // Create an anchor element for downloading
      const anchor = document.createElement("a");
      anchor.href = audioSource;
      anchor.download = "your-audio-file.mp3"; // Set the desired filename
      anchor.click();
    }
  };
    ...
    <div className={css["container"]}>
      <div className={css["main"]}>
        ...
        <div className={css["right"]}>
          <div >
            <button className={css["play"]} onClick={playAudio}>Play</button>
            <button className={css["pause"]} onClick={pauseAudio}>Pause</button>
            <button className={css["dow"]} onClick={downloadAudio}>Download</button>
          </div>
          <div>
